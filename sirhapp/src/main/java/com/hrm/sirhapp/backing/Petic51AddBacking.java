...
@Named
@ViewScoped
public class Petic51AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Petic51 newPetic51 = new Petic51();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Catalogo Reportes";
    ...
    public String register() {
        ...
        try {
            ...
            newPetic51.setStpet(Constants.RECORD_ACTIVED); 
            newPetic51.setFepet(new Date());
            newPetic51.setUspet(FacesUtil.getUserName());

            petic51Manager.registerPetic51(newPetic51);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Petic51AlreadyExists ex) {
            Logger.getLogger(Petic51AddBacking.class.getName()).log(Level.SEVERE, null, ex);
