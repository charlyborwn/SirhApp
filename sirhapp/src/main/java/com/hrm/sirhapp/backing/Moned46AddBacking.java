...
@Named
@ViewScoped
public class Moned46AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Moned46 newMoned46 = new Moned46();
    ...
    public String register() {
        ...
        try {
            ...
            newMoned46.setStmon(Constants.RECORD_ACTIVED); 
            newMoned46.setFemon(new Date());
            newMoned46.setUsmon(FacesUtil.getUserName());

            moned46Manager.registerMoned46(newMoned46);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Moned46AlreadyExists ex) {
            Logger.getLogger(Moned46AddBacking.class.getName()).log(Level.SEVERE, null, ex);
