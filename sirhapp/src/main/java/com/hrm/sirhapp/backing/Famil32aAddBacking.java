...
@Named
@ViewScoped
public class Famil32aAddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Famil32a newFamil32a = new Famil32a();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Famliares del Aspirante";
    ...
    public String register() {
        ...
        try {
            ...
            newFamil32a.setStfamA(Constants.RECORD_ACTIVED);
            newFamil32a.setFefamA(new Date());
            newFamil32a.setUsfamA(FacesUtil.getUserName());

            famil32aManager.registerFamil32a(newFamil32a);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Famil32aAlreadyExists ex) {
            Logger.getLogger(Famil32aAddBacking.class.getName()).log(Level.SEVERE, null, ex);
