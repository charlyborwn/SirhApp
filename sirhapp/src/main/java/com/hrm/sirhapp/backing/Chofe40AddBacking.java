...
@Named
@ViewScoped
public class Chofe40AddBacking extends BaseBacking implements Serializable {

    @EJB
    private Chofe40ManagerLocal moned46Manager;

    @Named
    @Produces
    @RequestScoped
    private Chofe40 newChofe40 = new Chofe40();
    ...
    public String register() {
        ...
        try {
            ...
            newChofe40.setStcho(Constants.RECORD_ACTIVED); 
            newChofe40.setFecho(new Date());
            newChofe40.setUscho(FacesUtil.getUserName());

            moned46Manager.registerChofe40(newChofe40);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Chofe40AlreadyExists ex) {
            Logger.getLogger(Chofe40AddBacking.class.getName()).log(Level.SEVERE, null, ex);
