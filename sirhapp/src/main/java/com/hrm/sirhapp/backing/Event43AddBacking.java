...
@Named
@ViewScoped
public class Event43AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Event43 newEvent43 = new Event43();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Eventos de Transporte";
    ...
    public String register() {
        ...
        try {
            ...
            newEvent43.setSteve(Constants.RECORD_ACTIVED); 
            newEvent43.setFeeve(new Date());
            newEvent43.setUseve(FacesUtil.getUserName());

            event43Manager.registerEvent43(newEvent43);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Event43AlreadyExists ex) {
            Logger.getLogger(Event43AddBacking.class.getName()).log(Level.SEVERE, null, ex);
