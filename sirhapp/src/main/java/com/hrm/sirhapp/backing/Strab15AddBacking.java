...
@Named
@ViewScoped
public class Strab15AddBacking extends BaseBacking implements Serializable {

    @EJB
    private Strab15ManagerLocal relig11Manager;

    @Named
    @Produces
    @RequestScoped
    private Strab15 newStrab15 = new Strab15();
    ...
    public String register() {
        ...
        try {
            ...
            newStrab15.setStstr(Constants.RECORD_ACTIVED); 
            newStrab15.setFestr(new Date());
            newStrab15.setUsstr(FacesUtil.getUserName());

            relig11Manager.registerStrab15(newStrab15);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Strab15AlreadyExists ex) {
            Logger.getLogger(Strab15AddBacking.class.getName()).log(Level.SEVERE, null, ex);
