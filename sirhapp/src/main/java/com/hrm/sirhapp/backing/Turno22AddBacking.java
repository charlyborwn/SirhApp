...
@Named
@ViewScoped
public class Turno22AddBacking extends BaseBacking implements Serializable {

    @EJB
    private Turno22ManagerLocal relig11Manager;

    @Named
    @Produces
    @RequestScoped
    private Turno22 newTurno22 = new Turno22();
    ...
    public String register() {
        ...
        try {
            ...
            newTurno22.setSttur(Constants.RECORD_ACTIVED); 
            newTurno22.setFetur(new Date());
            newTurno22.setUstur(FacesUtil.getUserName());

            relig11Manager.registerTurno22(newTurno22);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Turno22AlreadyExists ex) {
            Logger.getLogger(Turno22AddBacking.class.getName()).log(Level.SEVERE, null, ex);
