...
@Named
@ViewScoped
public class Ubica23AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Ubica23 newUbica23 = new Ubica23();
    ...
    public String register() {
        ...
        try {
            ...
            newUbica23.setStubi(Constants.RECORD_ACTIVED); 
            newUbica23.setFeubi(new Date());
            newUbica23.setUsubi(FacesUtil.getUserName());

            ubica23Manager.registerUbica23(newUbica23);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Ubica23AlreadyExists ex) {
            Logger.getLogger(Ubica23AddBacking.class.getName()).log(Level.SEVERE, null, ex);
