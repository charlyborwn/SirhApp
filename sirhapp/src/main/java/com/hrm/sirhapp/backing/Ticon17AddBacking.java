...
@Named
@ViewScoped
public class Ticon17AddBacking extends BaseBacking implements Serializable {

    @EJB
    private Ticon17ManagerLocal relig11Manager;

    @Named
    @Produces
    @RequestScoped
    private Ticon17 newTicon17 = new Ticon17();
    ...
    public String register() {
        ...
        try {
            ...
            newTicon17.setSttic(Constants.RECORD_ACTIVED); 
            newTicon17.setFetic(new Date());
            newTicon17.setUstic(FacesUtil.getUserName());

            relig11Manager.registerTicon17(newTicon17);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Ticon17AlreadyExists ex) {
            Logger.getLogger(Ticon17AddBacking.class.getName()).log(Level.SEVERE, null, ex);
