...
@Named
@ViewScoped
public class Tipyp20AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Tipyp20 newTipyp20 = new Tipyp20();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Tipos de Premios y Prestacines";
    ...
    public String register() {
        ...
        try {
            ...
            newTipyp20.setStpyp(Constants.RECORD_ACTIVED); 
            newTipyp20.setFepyp(new Date());
            newTipyp20.setUspyp(FacesUtil.getUserName());

            tipyp20Manager.registerTipyp20(newTipyp20);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Tipyp20AlreadyExists ex) {
            Logger.getLogger(Tipyp20AddBacking.class.getName()).log(Level.SEVERE, null, ex);
