...
@Named
@ViewScoped
public class Nacio09AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Nacio09 newNacio09 = new Nacio09();
    ...
    public String register() {
        ...
        try {
            ...
            newNacio09.setStnac(Constants.RECORD_ACTIVED); 
            newNacio09.setFenac(new Date());
            newNacio09.setUsnac(FacesUtil.getUserName());

            nacio09Manager.registerNacio09(newNacio09);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Nacio09AlreadyExists ex) {
            Logger.getLogger(Nacio09AddBacking.class.getName()).log(Level.SEVERE, null, ex);
