...
@Named
@ViewScoped
public class Exper31aAddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Exper31a newExper31a = new Exper31a();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Experiencias del Aspirante";
    ...
    public String register() {
        ...
        try {
            ...
            newExper31a.setStexpA(Constants.RECORD_ACTIVED);
            newExper31a.setFeexpA(new Date());
            newExper31a.setUsexpA(FacesUtil.getUserName());

            exper31aManager.registerExper31a(newExper31a);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Exper31aAlreadyExists ex) {
            Logger.getLogger(Exper31aAddBacking.class.getName()).log(Level.SEVERE, null, ex);
