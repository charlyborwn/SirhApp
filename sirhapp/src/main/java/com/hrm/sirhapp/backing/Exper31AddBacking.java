...
@Named
@ViewScoped
public class Exper31AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Exper31 newExper31 = new Exper31();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Experiencia del Trabajador";
    ...
    public String register() {
        ...
        try {
            ...
            newExper31.setFeexp(new Date());
            newExper31.setUsexp(FacesUtil.getUserName());
            ...
            Logger.getLogger(Exper31AddBacking.class.getName()).log(Level.SEVERE, null, ex);
