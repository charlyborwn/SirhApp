...
@Named
@ViewScoped
public class Estud10AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Estud10 newEstud10 = new Estud10();
    ...
    public String register() {
        ...
        try {
            ...
            newEstud10.setStest(Constants.RECORD_ACTIVED); 
            newEstud10.setFeest(new Date());
            newEstud10.setUsest(FacesUtil.getUserName());

            estud10Manager.registerEstud10(newEstud10);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Estud10AlreadyExists ex) {
            Logger.getLogger(Estud10AddBacking.class.getName()).log(Level.SEVERE, null, ex);
