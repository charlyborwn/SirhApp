...
@Named
@ViewScoped
public class Rutas41AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Rutas41 newRutas41 = new Rutas41();
    ...
    public String register() {
        ...
        try {
            ...
            newRutas41.setStrut(Constants.RECORD_ACTIVED); 
            newRutas41.setFerut(new Date());
            newRutas41.setUsrut(FacesUtil.getUserName());

            rutas41Manager.registerRutas41(newRutas41);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Rutas41AlreadyExists ex) {
            Logger.getLogger(Rutas41AddBacking.class.getName()).log(Level.SEVERE, null, ex);
