...
@Named
@ViewScoped
public class Unida42AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Unida42 newUnida42 = new Unida42();
    ...
    public String register() {
        ...
        try {
            ...
            newUnida42.setStuni(Constants.RECORD_ACTIVED); 
            newUnida42.setFeuni(new Date());
            newUnida42.setUsuni(FacesUtil.getUserName());

            unida42Manager.registerUnida42(newUnida42);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Unida42AlreadyExists ex) {
            Logger.getLogger(Unida42AddBacking.class.getName()).log(Level.SEVERE, null, ex);
