...
@Named
@ViewScoped
public class Depar03AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Depar03 newDepar03 = new Depar03();
    ...
    public String register() {
        ...
        try {
            ...
            newDepar03.setStdep(Constants.RECORD_ACTIVED); 
            newDepar03.setFedep(new Date());
            newDepar03.setUsdep(FacesUtil.getUserName());

            depar03Manager.registerDepar03(newDepar03);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Depar03AlreadyExists ex) {
            Logger.getLogger(Depar03AddBacking.class.getName()).log(Level.SEVERE, null, ex);
