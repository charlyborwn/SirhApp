...
@Named
@ViewScoped
public class Famil32AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Famil32 newFamil32 = new Famil32();
    ...
    public String register() {
        ...
        try {
            ...
            newFamil32.setFefam(new Date());
            newFamil32.setUsfam(FacesUtil.getUserName());
            ...
            Logger.getLogger(Famil32AddBacking.class.getName()).log(Level.SEVERE, null, ex);
