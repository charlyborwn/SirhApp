...
@Named
@ViewScoped
public class Tidoc18AddBacking extends BaseBacking implements Serializable {

    @EJB
    private Tidoc18ManagerLocal relig11Manager;

    @Named
    @Produces
    @RequestScoped
    private Tidoc18 newTidoc18 = new Tidoc18();
    ...
    public String register() {
        ...
        try {
            ...
            newTidoc18.setSttid(Constants.RECORD_ACTIVED); 
            newTidoc18.setFetid(new Date());
            newTidoc18.setUstid(FacesUtil.getUserName());

            relig11Manager.registerTidoc18(newTidoc18);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Tidoc18AlreadyExists ex) {
            Logger.getLogger(Tidoc18AddBacking.class.getName()).log(Level.SEVERE, null, ex);
