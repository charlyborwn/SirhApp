...
@Named
@ViewScoped
public class Tiinf38AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Tiinf38 newTiinf38 = new Tiinf38();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Tipos de Información";
    ...
    public String register() {
        ...
        try {
            ...
            newTiinf38.setSttin(Constants.RECORD_ACTIVED); 
            newTiinf38.setFetin(new Date());
            newTiinf38.setUstin(FacesUtil.getUserName());

            tiinf38Manager.registerTiinf38(newTiinf38);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Tiinf38AlreadyExists ex) {
            Logger.getLogger(Tiinf38AddBacking.class.getName()).log(Level.SEVERE, null, ex);
