...
@Named
@ViewScoped
public class Prove48AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Prove48 newProve48 = new Prove48();
    ...
    public String register() {
        ...
        try {
            ...
            newProve48.setStpro(Constants.RECORD_ACTIVED); 
            newProve48.setFepro(new Date());
            newProve48.setUspro(FacesUtil.getUserName());

            prove48Manager.registerProve48(newProve48);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Prove48AlreadyExists ex) {
            Logger.getLogger(Prove48AddBacking.class.getName()).log(Level.SEVERE, null, ex);
