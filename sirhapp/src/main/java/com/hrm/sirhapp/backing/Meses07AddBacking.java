...
@Named
@ViewScoped
public class Meses07AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Meses07 newMeses07 = new Meses07();
    ...
    public String register() {
        ...
        try {
            ...
            newMeses07.setStmes(Constants.RECORD_ACTIVED); 
            newMeses07.setFemes(new Date());
            newMeses07.setUsmes(FacesUtil.getUserName());

            meses07Manager.registerMeses07(newMeses07);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Meses07AlreadyExists ex) {
            Logger.getLogger(Meses07AddBacking.class.getName()).log(Level.SEVERE, null, ex);
