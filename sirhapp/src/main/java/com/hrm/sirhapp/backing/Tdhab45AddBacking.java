...
@Named
@ViewScoped
public class Tdhab45AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Tdhab45 newTdhab45 = new Tdhab45();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Tipos Domicilios";
    ...
    public String register() {
        ...
        try {
            ...
            newTdhab45.setSthab(Constants.RECORD_ACTIVED); 
            newTdhab45.setFehab(new Date());
            newTdhab45.setUshab(FacesUtil.getUserName());

            tdhab45Manager.registerTdhab45(newTdhab45);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Tdhab45AlreadyExists ex) {
            Logger.getLogger(Tdhab45AddBacking.class.getName()).log(Level.SEVERE, null, ex);
