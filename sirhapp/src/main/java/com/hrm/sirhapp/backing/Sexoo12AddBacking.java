...
@Named
@ViewScoped
public class Sexoo12AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Sexoo12 newSexoo12 = new Sexoo12();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Catalogo de sexos";
    ...
    public String register() {
        ...
        try {
            ...
            newSexoo12.setStsex(Constants.RECORD_ACTIVED); 
            newSexoo12.setFesex(new Date());
            newSexoo12.setUssex(FacesUtil.getUserName());

            sexoo12Manager.registerSexoo12(newSexoo12);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Sexoo12AlreadyExists ex) {
            Logger.getLogger(Sexoo12AddBacking.class.getName()).log(Level.SEVERE, null, ex);
