...
@Named
@ViewScoped
public class Espec05AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Espec05 newEspec05 = new Espec05();
    ...
    public String register() {
        ...
        try {
            ...
            newEspec05.setStesp(Constants.RECORD_ACTIVED); 
            newEspec05.setFeesp(new Date());
            newEspec05.setUsesp(FacesUtil.getUserName());

            espec05Manager.registerEspec05(newEspec05);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Espec05AlreadyExists ex) {
            Logger.getLogger(Espec05AddBacking.class.getName()).log(Level.SEVERE, null, ex);
