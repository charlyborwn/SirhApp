...
@Named
@ViewScoped
public class Razon02AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Razon02 newRazon02 = new Razon02();
    ...
    @PostConstruct
    private void init() {
        this.infoMessageModule = "Modulo Causas Sin Documento";
    ...
    public String register() {
        ...
        try {
            ...
            newRazon02.setStraz(Constants.RECORD_ACTIVED); 
            newRazon02.setFeraz(new Date());
            newRazon02.setUsraz(FacesUtil.getUserName());

            razon02Manager.registerRazon02(newRazon02);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Razon02AlreadyExists ex) {
            Logger.getLogger(Razon02AddBacking.class.getName()).log(Level.SEVERE, null, ex);
