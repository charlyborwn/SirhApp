...
@Named
@ViewScoped
public class Tipar19AddBacking extends BaseBacking implements Serializable {

    @EJB
    private Tipar19ManagerLocal relig11Manager;

    @Named
    @Produces
    @RequestScoped
    private Tipar19 newTipar19 = new Tipar19();
    ...
    public String register() {
        ...
        try {
            ...
            newTipar19.setSttip(Constants.RECORD_ACTIVED); 
            newTipar19.setFetip(new Date());
            newTipar19.setUstip(FacesUtil.getUserName());

            relig11Manager.registerTipar19(newTipar19);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Tipar19AlreadyExists ex) {
            Logger.getLogger(Tipar19AddBacking.class.getName()).log(Level.SEVERE, null, ex);
