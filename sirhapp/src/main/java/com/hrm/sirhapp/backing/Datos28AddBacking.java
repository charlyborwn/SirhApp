...
@Named
@ViewScoped
public class Datos28AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Datos28 newDatos28 = new Datos28();
    ...
    public String register() {
        ...
        try {
            ...
            newDatos28.setFedat(new Date());
            newDatos28.setUsdat(FacesUtil.getUserName());
