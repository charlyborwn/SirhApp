...
@Named
@ViewScoped
public class Comit08AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Comit08 newComit08 = new Comit08();
    ...
    public String register() {
        ...
        try {
            ...
            newComit08.setStcom(Constants.RECORD_ACTIVED); 
            newComit08.setFecom(new Date());
            newComit08.setUscom(FacesUtil.getUserName());

            comit08Manager.registerComit08(newComit08);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Comit08AlreadyExists ex) {
            Logger.getLogger(Comit08AddBacking.class.getName()).log(Level.SEVERE, null, ex);
