...
@Named
@ViewScoped
public class Sangr21AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Sangr21 newSangr21 = new Sangr21();
    ...
    public String register() {
        ...
        try {
            ...
            newSangr21.setStsan(Constants.RECORD_ACTIVED); 
            newSangr21.setFesan(new Date());
            newSangr21.setUssan(FacesUtil.getUserName());

            sangr21Manager.registerSangr21(newSangr21);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Sangr21AlreadyExists ex) {
            Logger.getLogger(Sangr21AddBacking.class.getName()).log(Level.SEVERE, null, ex);
