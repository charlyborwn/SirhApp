...
@Named
@ViewScoped
public class Civil06AddBacking extends BaseBacking implements Serializable {
    ...
    @Produces
    @RequestScoped
    private Civil06 newCivil06 = new Civil06();
    ...
    public String register() {
        ...
        try {
            ...
            newCivil06.setStciv(Constants.RECORD_ACTIVED); 
            newCivil06.setFeciv(new Date());
            newCivil06.setUsciv(FacesUtil.getUserName());

            civil06Manager.registerCivil06(newCivil06);

            infoMessage = "El registro se creo correctamente";
            FacesUtil.addMessage(FacesMessage.SEVERITY_INFO, infoMessageModule, infoMessage);

        } catch (Civil06AlreadyExists ex) {
            Logger.getLogger(Civil06AddBacking.class.getName()).log(Level.SEVERE, null, ex);
