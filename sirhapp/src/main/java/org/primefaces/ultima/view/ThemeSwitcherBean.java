...
public class ThemeSwitcherBean {
    ...
    static {
        ...
        themes.put("Ultima Blue", "ultima-blue");
        themes.put("Ultima Blue grey", "ultima-blue-grey");
        themes.put("Ultima Brown", "ultima-brown");
        themes.put("Ultima Brown", "ultima-cyan");
        themes.put("Ultima Dark blue", "ultima-dark-blue");
        themes.put("Ultima Dark green", "ultima-dark-green");
        themes.put("Ultima Green", "ultima-green");
        themes.put("Ultima Grey", "ultima-grey");
        themes.put("Ultima Indigo", "ultima-indigo");
        themes.put("Ultima Myown", "ultima-myown");
        themes.put("Ultima Purple amber", "ultima-purple-amber");
        themes.put("Ultima Purple cyan", "ultima-purple-cyan");
        themes.put("Ultima Teal", "ultima-teal");
        themes.put("Ultima Red", "ultima-red");
    }

    private static final List<Theme> advancedThemes;
    ...
    public Map<String, String> getThemesInMap() {
        return themes;
    }

    //value change event listener
    public void themesChanged(ValueChangeEvent e) {

        this.theme = e.getNewValue().toString();
